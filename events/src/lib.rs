	...
	pub fn notify(&self) -> Notification {
        match self {
            ...
            Self::Registration(d) => Notification {
                size: 30, color: ( 255, 2, 22), position: Position::Top, content: format!("You have {}H:{}M:{}S left before the registration ends", d.num_hours(), d.num_minutes(), d.num_seconds()).to_string() //13H:38M:14S
            },
